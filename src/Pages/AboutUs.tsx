const AboutUs = () => {
  return (
    ...
    //   <div className="text-center rounded-md bg-gray-800/50 lg:mx-52 p-7 mt-7 ">
  ...
  <div className="absolute inset-0 bg-[url('./assets/img/zombie-girl.webp')] bg-cover bg-center rounded-md"></div>
